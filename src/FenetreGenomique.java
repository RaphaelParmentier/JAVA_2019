...
/////////////////////////////BUILDER/////////////////////////////////
	...
	//@return le panel "CARTOUCHE DE SELECTION"
	...
	//@return le panel "CARTOUCHE D'INFORMATION"
	...
	//@param entier taille du genome ajustée
	...
	//@param entier taille du genome ajustée
	//@return le panel des elements
	private JPanel Cadre_1(int length)
	{
		JPanel panel = new JPanel(); //Initialisation panel
		panel.setPreferredSize(new Dimension(length,60)); //Initialise la taille de la bande qui contiendra les boutons
